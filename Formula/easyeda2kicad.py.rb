class Easyeda2kicadPy < Formula
  include Language::Python::Virtualenv

  desc "Convert any LCSC components (including EasyEDA) to KiCad library"
  homepage "https://github.com/uPesy/easyeda2kicad.py/tree/master"
  url "https://github.com/uPesy/easyeda2kicad.py/archive/refs/tags/v0.6.5.tar.gz"
  sha256 "9e5016cc201a4ed925db7170b859ac85041e62bf46d5431b8c68ceef6a15a597"
  ...
  test do
    ...
    output = shell_output("#{bin}/easyeda2kicad --help")
    assert_match "-- easyeda2kicad.py", output
  end
end
